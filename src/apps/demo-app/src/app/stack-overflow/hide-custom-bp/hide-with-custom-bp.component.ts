...
@Component({
  ...
  template: `
    <mat-card class="card-demo">
      ...
      <mat-card-subtitle>Hide when height < 800px using custom breakpoint <span style="font-weight: bold; color: #7a7af7;">fxHide.yba</span>
      </mat-card-subtitle>
      <mat-card-content>
        <div class="content"
             fxHide.yba
      ...
      <mat-card-footer class="bottomPad">
        <div class="hint">&lt;div fxLayout="row" fxLayout.xs="column" fxFlexFill fxHide.yba &gt;</div>
      </mat-card-footer>
    </mat-card>
  `
})
